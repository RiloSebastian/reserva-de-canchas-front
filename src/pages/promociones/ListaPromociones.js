...
const ListaPromociones = () => {
    ...
    const [data, setData] = useState([
        { name: 'Promo 1', description: 'Descuento con Tarjeta de Credito', descuento: '10%' },
        { name: 'Promo 2', description: 'Descuento en Canchas de Tenis', descuento: '20%' },
        { name: 'Promo 3', description: 'Descuento pack mensual', descuento: '15%' },
    ]);
