...
const ListaFeedback = () => {
    ...
    const [columns, setColumns] = useState([
        ...
        { title: 'Comentarios', field: 'comentario', initialEditValue: 'initial edit value' },
        //{ title: 'Birth Year', field: 'birthYear', type: 'numeric' },
        {
            title: 'Ratings',
            field: 'rating',
            customFilterAndSearch: (term, rowData) => term == rowData.rating,
            render: rowData => <RatingCourts rating={rowData.rating} />
        }
    ]);
    ...
    const [data, setData] = useState([
        ...
        { name: 'Sergio', comentario: 'La cancha 1 de tenis esta en mal estado', rating: 2 },
        { name: 'Marta', comentario: 'Los vestuarios estan sucios', rating: 2 },
        { name: 'Santiago', comentario: 'Las luces de las canchas estan muy buenas', rating: 4 },
    ]);
