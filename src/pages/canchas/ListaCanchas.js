...
const ListaCanchas = () => {
    ...
    const [columns, setColumns] = useState([
        ...
        {
            title: 'Horarios', field: 'horarios', render: rowData => <Button variant="contained">Ver Horarios</Button>,
            editComponent: props => (
                <Button color="warning" variant="contained" onClick={desplegarModal}>Modificar Horarios</Button>
            )
        },
    ]);
